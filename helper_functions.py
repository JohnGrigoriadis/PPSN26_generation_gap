"""Helper functions for Ackley and N Queens."""
...
def fitness_landscape_plot() -> None:
    ...
    z_multimodal = np.array(list(map(Ackley, positions))).reshape([
        resolution,
        resolution,
    ])
